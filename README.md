...
This project is a web application built with Flask that allows users to convert PDF documents into EPUB format. The conversion utilizes PyPDF2 for parsing the PDF files and ebooklib for creating the EPUB files.
